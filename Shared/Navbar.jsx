                            ...
                            <ul className='flex text-[18px] font-normal gap-8 '>
                                ...
                                <div className=''>
                                    ...
                                    '>
                                                ...
                                                <li className=' pl-4 cursor-pointer  font-semibold'><span className='hover:ml-2 transition-all duration-300'><Link to={'productsList/Casual'}>Casual</Link></span></li>
                                                <li className=' pl-4 cursor-pointer  font-semibold'><span className='hover:ml-2 transition-all duration-300'><Link to={'productsList/Formal'}>Formal</Link></span></li>
                                                <li className=' pl-4 cursor-pointer  font-semibold'><span className='hover:ml-2 transition-all duration-300'><Link to={'productsList/Gym'}>Gym</Link></span></li>
                                ...
                                <div className=''>
                                    ...
                                    '>
                                                ...
                                                <li className=' pl-4 cursor-pointer  font-semibold'><span className='hover:ml-2 transition-all duration-300'><Link to={'productsList/Party'}>Party</Link></span></li>
                                            </ul>
                                        </div>
                                    </li>
                                </div>
                                <div className=''>
                                    ...
                                    '>
                                                <li className=' pl-4 cursor-pointer  font-semibold relative group/li'>
                                                    <Link className='flex justify-between items-center' to={'/productsList/T-Shirt'}>
                                                        <span className=' hover:ml-2 transition-all duration-300'>T-shirt</span>
                                                    </Link>
                                                </li>
                                                <li className=' pl-4 cursor-pointer  font-semibold relative group/li'>
                                                    <Link className='flex justify-between items-center' to={'/productsList/Shorts'}>
                                                        <span className=' hover:ml-2 transition-all duration-300'>Shorts</span>
                                                    </Link>
                                                </li>
                                                ...
                                                <li className=' pl-4 cursor-pointer font-semibold whitespace-nowrap'>
                                                    <span className='hover:ml-2 transition-all duration-300'>
                                                        <Link to={'/productsList/Sweatpants'}>Sweatpants</Link>
                                                    </span>
                                                </li>
                                                <li className=' pl-4 cursor-pointer font-semibold whitespace-nowrap'>
                                                    <span className='hover:ml-2 transition-all duration-300'>
                                                        <Link to={'/productsList/Polo Shirt'}>Polo Shirt</Link>
                                                    </span>
                                                </li>
                                                <li className=' pl-4 cursor-pointer font-semibold whitespace-nowrap'>
                                                    <span className='hover:ml-2 transition-all duration-300'>
                                                        <Link to={'/productsList/Dungarees'}>Dungarees</Link>
                                                    </span>
                                                </li>
                                                <li className=' pl-4 cursor-pointer font-semibold whitespace-nowrap'>
                                                    <span className='hover:ml-2 transition-all duration-300'>
                                                        <Link to={'/productsList/Bomber Jacket'}>Bomber Jacket</Link>
                                                    </span>
                                                </li>
                                ...
                                <div className=''>
                                    ...
                                    '>
                                                <li className=' pl-4 cursor-pointer  font-semibold relative group/li'>
                                                    <Link className='flex justify-between items-center' to={'/productsList/Frock'}>
                                                        <span className=' hover:ml-2 transition-all duration-300'>Frock</span>
                                                    </Link>
                                                </li>
                                                <li className=' pl-4 cursor-pointer  font-semibold relative group/li'>
                                                    <Link className='flex justify-between items-center' to={'/productsList/Skirt'}>
                                                        <span className=' hover:ml-2 transition-all duration-300'>Skirt</span>
                                                    </Link>
                                                </li>
                                                <li className=' pl-4 cursor-pointer font-semibold whitespace-nowrap'>
                                                    <span className='hover:ml-2 transition-all duration-300'>
                                ...
                                <div className=''>
                                    ...
                                    '>
                                                <li className=' pl-4 cursor-pointer  font-semibold relative group/li'>
                                                    <Link className='flex justify-between items-center' to={'/productsList/Rompers'}>
                                                        <span className=' hover:ml-2 transition-all duration-300'>Rompers</span>
                                                    </Link>
                                                </li>
                                                <li className=' pl-4 cursor-pointer  font-semibold relative group/li'>
                                                    <Link className='flex justify-between items-center' to={'/productsList/Jumpsuit'}>
                                                        <span className=' hover:ml-2 transition-all duration-300'>Jumpsuit</span>
                                                    </Link>
                                                </li>
                                                <li className=' pl-4 cursor-pointer font-semibold whitespace-nowrap'>
                                                    <span className='hover:ml-2 transition-all duration-300'>
                                                ...
                                                <li className=' pl-4 cursor-pointer font-semibold whitespace-nowrap'>
                                                    <span className='hover:ml-2 transition-all duration-300'>
                                                        <Link to={'/productsList/Tracksuit'}>Tracksuit</Link>
                                                    </span>
                                                </li>
                                            </ul>
                                        </div>
