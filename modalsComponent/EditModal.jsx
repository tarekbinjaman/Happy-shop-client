...
const EditModal = ({ id, handleClose }) => {
  ...
  const handleImageUpload = async (files) => {
    ...
    try {
      ...
      setErrorMsg(
        "Image upload failed. Please try again. Try to upload one after another"
      );
    } finally {
      setUploading(false);
  ...
  return (
    <div className="flex justify-center">
      <form
        ...
        className=" p-6 bg-white rounded-xl shadow space-y-6 lg:w-4xl md:w-full "
      >
        <div className="">
          {/* main div */}
              ...
              <div className="">
                ...
                <div className="md:grid md:grid-cols-2 lg:grid-cols-5 gap-2 mt-2">
                  {size.map((SZ, index) => (
                    <div
                      key={index}
                      className="flex items-center justify-between gap-3 border rounded bg-gray-100"
                    >
            ...
            <div className="flex gap-4 my-4 justify-between">
              ...
              <div>
                ...
                >
                  ...
                  <option value="Gown">Rompers</option>
              ...
              <div>
                ...
                {errors.fitType && (
                  <p className="text-red-500">{errors.fitType.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.materials && (
                  <p className="text-red-500">{errors.materials.message}</p>
                )}
              </div>
              {/* gender */}
              <div>
