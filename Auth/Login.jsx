                    ...
                    <div className=' bg-white rounded-2xl p-6 pt-8 absolute w-full z-10 -mt-72'>
                        ...
                        <div className='form-control'>
                            <form onSubmit={handleSubmit(onsubmit)}>
                                ...
                                <button className='btn bg-pink-500 text-white mt-2'>Submit</button>
                                <div className='flex justify-between items-end-safe'>
                                <p>New here? <Link to={'/register'} className='text-blue-400 underline'>Register now!</Link></p>
                                <div className='flex justify-center 4'>
                                    <button className='cursor-pointer flex gap-2 items-center btn' onClick={googleClick}> <FcGoogle className='text-xl' /> Sign in</button>
                                </div>
                                </div>
                            </form>
                        </div>
